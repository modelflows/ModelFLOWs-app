...
The deep learning architecture implemented is: convolutional neural network (CNN).
 """)
    ...
    if not os.path.exists(f'{path0}/CNN_solution'):
        os.mkdir(f'{path0}/CNN_solution')
    ...
    val_prop = 0.20 # validation set proportion val_length = (1-test_prop)*val_prop // train_length = (1-test_prop)*(1-val_prop)
    ...
    if go:
        with st.spinner("Please wait while the model is being trained"):
            if not os.path.exists(f'{path0}/hyb_CNN_solution/'):
                os.mkdir(f'{path0}/hyb_CNN_solution/') 
            ...
            if output1 == 'yes':
                ...
                if output1 == 'yes': 
                    ...
                    st.write('\n')  
                    np.save(f'{path0}/hyb_CNN_solution/RRMSE_SVD.npy',RRMSE_SVD)
            ...
            # Preparing the model
            def create_model_cnn(in_shape,  out_dim, p = 3, shared_dim = 1000, act_fun= act_func1, act_func2 = act_func2):
            ...
            save_string = 'colab_Cilin3D_AML_20_CNN v1'

            # save the best weights 
            save_best_weights = f'{path0}/hyb_CNN_solution/' + save_string + '.h5'
            save_summary_stats = f'{path0}/hyb_CNN_solution/' + save_string + '.csv'
            save_last_weights = f'{path0}/hyb_CNN_solution/' + save_string + '_last_w.h5'
            save_results_metrics = f'{path0}/hyb_CNN_solution/' + save_string + '_results_metrics.csv'
        ...
        st.write("### Model Training Results - 1D CNN")

    
        if not os.path.exists(f'{path0}/hyb_CNN_solution/plots'):
            os.mkdir(f'{path0}/hyb_CNN_solution/plots')
        ...
        if output3 == 'yes':
            ...
            plt.savefig(f'{path0}/hyb_CNN_solution/loss.png')
            st.pyplot(fig)
            plt.close()
        ...
        plt.savefig(f'{path0}/hyb_CNN_solution/plots/MSEscore.png')
        st.pyplot(fig)
        plt.close()
        ...
        plt.savefig(f'{path0}/hyb_CNN_solution/plots/MAEscore.png')
        st.pyplot(fig)
        plt.close()
        ...
        plt.savefig(f'{path0}/hyb_CNN_solution/plots/MADscore.png')
        st.pyplot(fig)
        plt.close()
        ...
        plt.savefig(f'{path0}/hyb_CNN_solution/plots/R2score.png')
        st.pyplot(fig)
        plt.close()
        ...
        plt.savefig(f'{path0}/hyb_CNN_solution/plots/SMAPEscore.png')
        st.pyplot(fig)
        plt.close()
        ...
        plt.savefig(f'{path0}/hyb_CNN_solution/plots/RRMSEscore.png')
        st.pyplot(fig)
        plt.close()
        ...
        if output4 == 'yes':
            ...
            st.write('\n')
            np.save(f"{path0}/hyb_CNN_solution/RRMSE_orNN.npy", RRMSE_orNN)
        ...
        if output5 == 'yes':
            ...
            st.write('\n')
            np.save(f"{path0}/hyb_CNN_solution/RRMSE_trNN.npy", RRMSE_trNN)
        ...
        if output6 == 'yes':
            ...
            ax.set_xlabel('Time')
            ax.set_ylabel('RRMSE')
            plt.savefig(f'{path0}/hyb_CNN_solution/plots/rrmse.png')
            st.pyplot(fig)
            plt.close()
        ...
        if output7 == 'yes':
            # AML Comparation
            if not os.path.exists(f'{path0}/hyb_CNN_solution/Mode_Comparison'):
                os.mkdir(f"{path0}/hyb_CNN_solution/Mode_Comparison")
            ...
            for i in nModes:
                ...
                plt.savefig(f'{path0}/hyb_CNN_solution/Mode_Comparison/aMLComparation_m_{i}_test.png')
                st.pyplot(fig)  
                plt.close()              
                if output2 == 'yes':
                    fig, ax = plt.subplots()
                    ...
                    namefig1 = f'{path0}/hyb_CNN_solution/Mode_Comparison/aMLComparation_m_{i}_all.png'
        ...
        # Tensor Comparison
        if output8 == 'yes':
            if not os.path.exists(f'{path0}/hyb_CNN_solution/Snapshots'):
                os.mkdir(f"{path0}/hyb_CNN_solution/Snapshots")
            
            for i in range(index.shape[0]):
                namefig_orig1 = f'{path0}/hyb_CNN_solution/Snapshots/snap_comp{index[i,0]+1}_t{index[i,1]+1}.png'
                fig, ax = plt.subplots()
